...
function Fundo(cenarioFalas, estadoAtual, gameState){
    ...
    imagemFundo.setAttribute("id", "imagemFundo")
    imagemFundo.src = "Img/RUA.png" 
    imagemFundo.repeate =    
    gameState["fundo"].style.background-image = imagemFundo
    ...
    personagemDireita.setAttribute("id", "personagemDireita")
    personagemDireita.src = "Img/personagemVazio"
    ...
    personagemEsquerda.setAttribute("id", "personagemEsquerda")
    personagemEsquerda.src = "Img/personagemVazio"
...
function adicionaBalao(cenarioFalas, gameState) {
    ...
    gameState["fundo"].appendChild(containerNovoBalao)
    gameState["containerNovoBalao"] = containerNovoBalao
    const novoBalao = document.createElement("div")
    novoBalao.setAttribute("id", "dialogoPersonagem")
...
function mudaImagem(imagemFundo, cenarioFalas, estadoAtual){

}
function mudaFundo(cenarioFalas, estadoAtual, gameState){
    
    mudaImagem(gameState["imagemFundo"], cenarioFalas, estadoAtual)
